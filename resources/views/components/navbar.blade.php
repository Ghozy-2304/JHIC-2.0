...
<div class="fixed top-0 left-0 right-0 z-50 flex justify-center py-4 px-4 bg-white/75 backdrop-blur-md">
    
    <!-- NAVBAR CARD (Figma Spec: 1120px width, 60px height, rounded-full, drop-shadow 0px 4px 15px rgba(0,0,0,0.04)) -->
    <div class="w-[1120px] max-w-full bg-white h-[60px] flex items-center justify-between px-3 rounded-full shadow-[0px_4px_15px_rgba(0,0,0,0.05)] border border-slate-100 relative">
